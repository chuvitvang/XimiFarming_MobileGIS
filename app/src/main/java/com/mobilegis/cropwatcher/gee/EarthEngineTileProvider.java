...
public class EarthEngineTileProvider implements TileProvider {
    ...
    public EarthEngineTileProvider(android.content.Context context, String tileUrlTemplate, List<Plot> plots, EarthEngineClient geeClient) {
        ...
        this.plotId = this.plotsList.isEmpty() ? -1 : this.plotsList.get(0).getId();
    ...
    public Tile getTile(int x, int y, int zoom) {
        ...
        if (cacheFile.exists()) {
            ...
            if (cachedData != null && cachedData.length > 0) {
                ...
                return new Tile(TILE_SIZE, TILE_SIZE, cachedData);
            }
        }
    ...
    private java.io.File getCacheFile(int plotId, int x, int y, int zoom) {
    ...
    public static void clearTileCacheForPlot(android.content.Context context, int plotId) {
        try {
            java.io.File cacheDir = new java.io.File(context.getCacheDir(), "gee_tiles/" + plotId);
